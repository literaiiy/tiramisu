...
############################################################################ SKYWARS ##########################################################################################s
        ...
        ########## SkyWars Mode Stats 2
        def swModeStats2(statsList, gamemoder):
            try:
                swVAR = reqAPI['player']['stats']['SkyWars']
                try:

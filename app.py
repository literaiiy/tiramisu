...
from requests.packages.urllib3.util.retry import Retry #f
...
HAPIKEY = 'a8640f1c-f857-4acf-9e99-e3a52f36c804' # alt account's
...
# ! Name history
        # print(MojangAPI.get_name_history(uuid))
